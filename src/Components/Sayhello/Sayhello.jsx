...
function Sayhello() {
  return (
    <div className="flex justify-center">
      <section className="flex justify-between flex-col border-2 my-20 h-56 w-2/4">
        ...
        <div className="flex justify-center flex-col align-center flex-grow">
          <h3 className="text-white text-center mb-4 text-base">
            Want to work together or have any questions?
          </h3>
          <button
            className="text-white text-base font-bold bg-green-500 w-36 h-14 self-center mt-3"
